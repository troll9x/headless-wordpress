...
export default function QuickAccessLinks({ items }: QuickAccessLinksProps) {
          ...
          {items.map((item, idx) => {
            ...
            return (
              <Link
                ...
                className="group flex flex-col items-center justify-center gap-2 rounded-xl border border-slate-100 bg-white p-4 text-center shadow-sm transition-all hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md"
              >
                <div
                ...
                <span
                  className="text-xs font-medium leading-snug text-slate-700 transition-colors group-hover:text-blue-800 sm:text-sm"
